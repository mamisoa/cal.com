/**
 * getTeamMemberEmailFromCrm - AGPL-3.0 Licensed
 *
 * Utility to get team member email from CRM for round-robin scheduling.
 *
 * @module @calcom/features/teams/lib/getTeamMemberEmailFromCrm
 * @license AGPL-3.0
 */
