/**
 * Prisma Team Billing Data Repository - AGPL-3.0 Licensed
 *
 * Repository for fetching team billing data using Prisma.
 *
...
/**
 * Prisma implementation of team billing data repository.
 */
export class PrismaTeamBillingDataRepository implements ITeamBillingDataRepository {
  ...
  /**
   * Fetch a single team by subscription ID
   */
